...
export const transactions = sqliteTable("transactions", {
  ...
  status: text("status", { enum: ["draft", "paid", "void", "refunded"] })
    .notNull()
    .default("draft"),
  payment_method: text("payment_method", {
    enum: ["cash", "qris", "edc_debit", "edc_credit", "transfer", "split"],
  }).notNull(),
  notes: text("notes"),
...
export const transactionItemModifiers = sqliteTable("transaction_item_modifiers", {
